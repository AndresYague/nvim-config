...
-- NOTE: This is currently creating the message "press enter"
-- for no reason. So maybe wait until it is fixed
-- Meanwhile, uncomment to automatically install these languages
-- upon entering neovim
